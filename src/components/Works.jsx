...
import works from "../assets/works-pana.svg";
...
export default function Works ({}) {
    ...
    return (
        <section className="min-h-screen h-fit w-full  flex flex-col justify-start items-end">
            <div className="w-2/3 mr-40 flex flex-col gap-10 justify-start items-center">
                <div className="w-full flex flex-col justify-center items-center ">
                    <img src={works} className="w-full h-[70vh] object-cover"/>
                    <h2 className="w-fit mt-4 xs:text-[2rem] sm:text-[3rem] uppercase">Works</h2>
                </div>
                <p>A collection of my work across UI/UX design, web development, social media marketing, and content creation. From designing intuitive digital experiences to producing engaging visuals, photography, and video content, each project showcases my skills in crafting compelling and effective digital solutions.</p>
