                ...
                <div className="w-full flex justify-around items-start ">
                    ...
                    <div onClick={() => setOpenPanel(1)} className={`${openPanel === 1 ? "shadow-md shadow-orange/25 hover:shadow-orange/25" : ""} group relative overflow-hidden max-w-[300px] min-h-80 bg-white rounded-xl shadow-2xl cursor-pointer hover:shadow-md flex items-end justify-center transition-all duration-200`}>
                        <div className="max-h-32 absolute top-0 w-full h-fit ">
                            <img src={ui} className={`${openPanel === 1 ? "opacity-100" : "opacity-50"} absolute -top-2 -right-28 scale-[180%] group-hover:opacity-100 transition-all duration-200`}/>
                        </div>
                    ...
                    <div onClick={() => setOpenPanel(2)} className={`${openPanel === 2 ? "shadow-md shadow-orange/25 hover:shadow-orange/25" : ""} group relative overflow-hidden min-w-[300px] max-w-[300px] min-h-[320px] bg-white rounded-xl shadow-2xl cursor-pointer hover:shadow-md flex items-end transition-all duration-200`}>
                        <div className="max-h-32 absolute top-0 w-full  h-fit ">
                        ...
                        <div className="relative bg-white w-full h-[65.6px] flex items-center justify-center z-10 px-4 pb-2 pt-0">
                            <h3 className="text-[1.5rem] text-center">Photography</h3>
                        </div>
                    </div>
                    </article>
                    <article className="social-panel flex flex-col justify-center gap-10 ">
                    <div onClick={() => setOpenPanel(3)} className={`${openPanel === 3 ? "shadow-md shadow-orange/25 hover:shadow-orange/25" : ""} group relative overflow-hidden min-w-[300px] max-w-[300px] min-h-[320px] bg-white rounded-xl shadow-2xl cursor-pointer hover:shadow-md flex items-end transition-all duration-200`}>
                        <div className="max-h-32 absolute top-0 w-full h-fit ">
