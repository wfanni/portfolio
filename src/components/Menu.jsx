...
export default function Menu({
  ...
  return (
    <div className={`fixed h-screen pt-8 w-64 z-10 top-0 left-0 bg-opacity-100 bg-gradient-to-r from-white via-white/60 to-transparent text-dark transition-all duration-200`}>
