...
const AboutLong = forwardRef(function AboutLong({lang}, ref) {
  const { t } = useTranslation();
    return (
        <section ref={ref} className="min-h-screen h-fit py-16 flex flex-col justify-center items-center gap-12">
