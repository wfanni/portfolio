      ...
      <div className="relative w-1/2 flex justify-center items-center gap-12">
        ...
        <div className="w-full flex flex-col justify-between items-start gap-12">
          <div className=" w-full flex justify-between">
            <span
              className={`${isCopied ? "text-orange" : ""} group z-10 py-2 px-4 pt-[0.6rem] cursor-pointer border-2 border-transparent hover:border-orange rounded-full transition-all duration-200`}
