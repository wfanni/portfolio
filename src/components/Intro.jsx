...
export default function Intro() {
    ...
    return (
        <section className="xs:h-[100vh] sm:h-screen relative flex flex-col items-center justify-center">
            ...
            <span className="absolute xs:text-4xl sm:text-[4rem] xl:translate-x-[-210px] uppercase animate-fadeInLeft xl:animate-fadeInLeftXL">Hi, I'm Fanni</span>
                <span className={`absolute ${subtitleOpacity === false ? 'opacity-0' : 'opacity-100'} xs:text-xl sm:text-[2.5rem] translate-y-[3.5rem] xl:translate-x-[240px] text-orange uppercase animate-fadeInRight xl:animate-fadeInRightXL`}>Frontend Developer</span>
            </h1>
        </section>
    )
}