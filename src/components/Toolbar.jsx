...
export default function Toolbar({ scrollPosition, sections }) {
    ...
    return (
        <div className="xs:fixed lg:static w-full xs:z-20 lg:z-0">
            ...
            <ul className={`${scrollStylesUl} ${isMenuOpen ? 'xs:translate-y-0' : 'xs:-translate-y-[100vh] lg:translate-y-0'} xs:min-h-[100vh] lg:min-h-16 w-full xs:py-20 lg:py-0 xs:z-60 lg:z-10 xs:absolute lg:fixed top-0 flex xs:flex-col lg:flex-row xs:justify-between lg:justify-center items-center xs:gap-0 lg:gap-24 transition-all duration-200`} >
