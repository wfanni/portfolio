            ...
            <section className="relative xs:w-4/5 lg:w-3/4 flex xs:flex-col-reverse lg:flex-row xs:justify-center xs:items-center lg:justify-between xs:gap-8 lg:gap-0">
                <div className="flex flex-col gap-6 xs:items-center lg:items-start">
                    ...
                    <div className="flex flex items-center gap-6">
                        <span className="text-orange font-bold">Check it out live!</span>
                        <a href="https://wfanni.github.io/project-management-app/" target="_blank"><i className="hover:text-orange duration-200 transition-all fa-solid fa-globe text-[1.6rem]"></i></a>
                        <a href="https://github.com/wfanni/project-management-app" target="_blank"><i className="hover:text-orange duration-200 transition-all fa-brands fa-github text-[1.7rem]"></i></a>
                    </div>
