          ...
          <div className="w-full flex items-center justify-between gap-12">
            <Link onClick={() => setOpenPanel(1)}>
              <div className="group relative overflow-hidden max-w-[300px] min-h-80 bg-white rounded-xl shadow-2xl cursor-pointer hover:shadow-md flex items-end justify-center transition-all duration-200">
                ...
                <div className="flex items-center justify-center relative bg-white min-h-[100px] w-full z-10 px-4 pb-2 pt-2">
                  <h3 className="text-[1.5rem] text-center">UI/UX Design & Development</h3>
                </div>
              </div>
            </Link>
            <Link onClick={() => setOpenPanel(2)}>
              <div className="group relative overflow-hidden max-w-[300px] min-w-[300px] min-h-80 bg-white rounded-xl shadow-2xl cursor-pointer hover:shadow-md flex items-end justify-center transition-all duration-200">
                <div className="max-h-32 absolute top-0 w-full h-fit ">
                  <img src={photo} className="absolute -top-4 right-0 scale-[100%] opacity-50 group-hover:opacity-100 transition-all duration-200"/>
                </div>
                <div className="flex items-center justify-center relative bg-white min-h-[100px] w-full z-10 px-4 pb-2 pt-2">
            ...
            <Link onClick={() => setOpenPanel(3)}>
              <div className="group relative overflow-hidden max-w-[300px] min-h-80 bg-white rounded-xl shadow-2xl cursor-pointer hover:shadow-md flex items-end justify-center transition-all duration-200">
                <div className="max-h-32 absolute top-0 w-full h-fit ">
                  <img src={social} className="absolute -top-6 right-0 scale-[100%] opacity-50 group-hover:opacity-100 transition-all duration-200"/>
                </div>
                <div className="flex items-center justify-center relative bg-white min-h-[100px] w-full z-10 px-4 pb-2 pt-2">
